            ...
            >
                ...
                <div className={classes.drawerContainer}>
                    <div className="content__sidebar">
                        ...
                        <NavLink to="/admin/spamcompanies/" className="sidebar__link" activeClassName="sidebar__link--active" >
                            <Typography>
                                Spam-Companies
                            </Typography>
                        </NavLink>
                        <NavLink to="/admin/spamexperiences/" className="sidebar__link" activeClassName="sidebar__link--active" >
                            <Typography>
                                Spam-Experiences
                            </Typography>
                        </NavLink>
