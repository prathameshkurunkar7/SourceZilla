...
import SpamCompanies from './components/Admin/SpamCompanies/SpamCompanies'
import SpamExperiences from './components/Admin/SpamExperiences/SpamExperiences';
...
import InterviewExp from './components/InterviewCorner/InterviewExp'
...
import CompaniesList from './components/InterviewCorner/CompaniesList';
import InterviewExpsByCompanyID from './components/InterviewCorner/InterviewExpsByCompanyID';
import InterviewShow from './components/InterviewCorner/InterviewShow';
      ...
      <AnimatePresence >
        <div className="App">
          <Switch location={isModal ? this.previousLocation : location} key={location.pathname} >
            ...
            <AdminAuth exact path="/admin/spamcompanies/" component={(props) => <SpamCompanies {...props} />} />
            <AdminAuth exact path="/admin/spamexperiences/" component={(props) => <SpamExperiences {...props} />} />
